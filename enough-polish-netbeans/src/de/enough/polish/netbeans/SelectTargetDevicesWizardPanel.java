 ...
 */
public class SelectTargetDevicesWizardPanel implements WizardDescriptor.Panel,
        WizardDescriptor.ValidatingPanel, WizardDescriptor.FinishablePanel {
    
    private WizardDescriptor wizardDescriptor;
    private SelectTargetDevicesPanelVisual component;
    
    /** Creates a new instance of templateWizardPanel */
    public SelectTargetDevicesWizardPanel() {
    }
