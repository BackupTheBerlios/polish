 ...
 */
public class VerticalShutterScreenChangeAnimation extends ScreenChangeAnimation
{	
	private int currentX;
	//#if polish.css.vertical-shutter-screen-change-animation-speed
	private int speed = 2;
	//#endif
	//#if polish.css.vertical-shutter-screen-change-animation-color
	private int color = 0;
	//#endif
	 ...
	 */
	public VerticalShutterScreenChangeAnimation()
	{
		// Do nothing here.
	}

	//#if polish.css.vertical-shutter-screen-change-animation-speed || polish.css.vertical-shutter-screen-change-animation-color
	/* (non-Javadoc)
	...
	{
		//#if polish.css.vertical-shutter-screen-change-animation-speed
		Integer speedInt = style.getIntProperty("vertical-shutter-screen-change-animation-speed");
		...
		//#if polish.css.vertical-shutter-screen-change-animation-color
		Integer colorInt = style.getIntProperty("vertical-shutter-screen-change-animation-color");
