 ...
 */
public class ShutterScreenChangeAnimation extends ScreenChangeAnimation
{	
	private int currentY;
	//#if polish.css.shutter-screen-change-animation-speed
	private int speed = 2;
	//#endif
	 ...
	 */
	public ShutterScreenChangeAnimation()
	{
		// Do nothing here.
	}

	//#if polish.css.shutter-screen-change-animation-speed || polish.css.shutter-screen-change-animation-color
	/* (non-Javadoc)
	...
	{
		//#if polish.css.shutter-screen-change-animation-speed
		Integer speedInt = style.getIntProperty("shutter-screen-change-animation-speed");
		...
		//#if polish.css.shutter-screen-change-animation-color
		Integer colorInt = style.getIntProperty("shutter-screen-change-animation-color");
