 ...
 * <TD><CODE><B><A HREF="RecordFilter.html#matches(byte[])" tppabs="http://java.sun.com/javame/reference/apis/jsr118/javax/microedition/rms/RecordFilter.html#matches(byte[])">matches</A></B>(byte[]&nbsp;candidate)</CODE>
 * 
 * <BR>
 * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Returns true if the candidate matches the implemented criterion.</TD>
 * </TR>
 * </TABLE>
 * &nbsp;
 * 
 ...
 * </TABLE>
 * 
 * <A NAME="matches(byte[])"><!-- --></A><H3>
 * matches</H3>
 * <PRE>
 * public boolean <B>matches</B>(byte[]&nbsp;candidate)</PRE>
 * <DD>Returns true if the candidate matches the implemented criterion.
 ...
 * <TD BGCOLOR="#EEEEFF" CLASS="NavBarCell1">    <A HREF="class-use/RecordFilter.html" tppabs="http://java.sun.com/javame/reference/apis/jsr118/javax/microedition/rms/class-use/RecordFilter.html"><FONT CLASS="NavBarFont1"><B>Use</B></FONT></A>&nbsp;</TD>
 ...
 * &nbsp;<A HREF="RecordEnumeration.html" tppabs="http://java.sun.com/javame/reference/apis/jsr118/javax/microedition/rms/RecordEnumeration.html" title="interface in javax.microedition.rms"><B>PREV CLASS</B></A>&nbsp;
 * &nbsp;<A HREF="RecordListener.html" tppabs="http://java.sun.com/javame/reference/apis/jsr118/javax/microedition/rms/RecordListener.html" title="interface in javax.microedition.rms"><B>NEXT CLASS</B></A></FONT></TD>
 * <TD BGCOLOR="white" CLASS="NavBarCell2"><FONT SIZE="-2">
 * <A HREF="../../../index.html" tppabs="http://java.sun.com/javame/reference/apis/jsr118/index.html" target="_top"><B>FRAMES</B></A>  &nbsp;
 * &nbsp;<A HREF="RecordFilter.html" tppabs="http://java.sun.com/javame/reference/apis/jsr118/javax/microedition/rms/RecordFilter.html" target="_top"><B>NO FRAMES</B></A>  &nbsp;
