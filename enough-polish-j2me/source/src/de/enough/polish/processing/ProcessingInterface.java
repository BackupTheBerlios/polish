...
public interface ProcessingInterface {
     ...
     * @param should the last frame time be updated also?
     */
     ...
     * @param Either RGB or HSB, corresponding to Red/Green/Blue and Hue/Saturation/Brightness
     */
     ...
     * @param Either RGB or HSB, corresponding to Red/Green/Blue and Hue/Saturation/Brightness
     * @param range for all color elements
     */
     ...
     * @param Either RGB or HSB, corresponding to Red/Green/Blue and Hue/Saturation/Brightness
     * @param range for the red or hue depending on the current color mode
     * @param range for the green or saturation depending on the current color mode
     * @param range for the blue or brightness depending on the current color mode
     */
     ...
     * @param shade of gray, between 0 and 255
     ...
     * Creates colors for storing in variables of the color datatype. The resulting color is a shade of gray.
     * @param shade of gray, between 0 and 255
     * @param alpha level (NOTE: on current MIDP 2.1 devices and below this is ignored)
     * @return the resulting color
     */
     ...
     * @param the shade of gray to use, between 0 and 255
     */
     ...
     * @param x-coordinate of the first corner
     * @param y-coordinate of the first corner
     * @param x-coordinate of the second corner
     * @param y-coordinate of the second corner
     * @param x-coordinate of the third corner
     * @param y-coordinate of the third corner
     * @param x-coordinate of the fourth corner
     * @param y-coordinate of the fourth corner
     */
     ...
     * @param Either CORNER, CORNERS, CENTER
     */
     ...
     * @param x-coordinate of the ellipse
     * @param y-coordinate of the ellipse
     ...
     * @param Either CENTER, CENTER_RADIUS, CORNER, CORNERS.
     */
     ...
     * @param Either LINES, LINE_STRIP, LINE_LOOP, TRIANGLES, TRIANGLE_STRIP, QUADS, QUAD_STRIP, POLYGON
     * @see #endShape()
     */
    ...
    /**
     * Loads an image into a variable of type PImage. Only .png images may be loaded. To load correctly, images must be located in the data directory of the current sketch. In most cases, load all images in setup()  to preload them when the program starts. Loading images in draw()  can dramatically reduce the speed of a program.
     * @param array of bytes of image data in .png format
     * @return the resulting PImage
     */
     ...
     * @param x-coordinate of the sub-area in the image
     * @param y-coordinate of the sub-area in the image
     * @param width of the sub-area in the image
     * @param height of the sub-area in the image
     * @param destination x-coordinate of the image
     * @param destination y-coordinate of the image
     * @see #imageMode(int)
     */
     ...
     * @param the custom label on the softkey
     */
     ...
     * @param the label on the softkey
     */
    ...
    /**
     * The textInput function will open a new screen in which the user can input text using the native text input methods of the mobile phone (i.e. T9). Execution of the sketch will be paused until the text input screen is dismissed by the user. The text will be returned as a string.
     * @param title of the text input form
     * @param default text of the form
     * @param maximum length of the user entered text
     * @return the user-entered text
     */
     ...
     * @param the source array
     * @param the separator string
     * @param desired number of digits for each number
     * @return the resulting string
     */
    ...
    /**
     * Decreasez the size of an array
     * @param array
     * @param new size
     * @return resulting array
     */
    ...
    /**
     * Increasez the size of an array to the specified size
     * @param array
     * @param new size
     * @return resulting array
     */
     ...
     * @param horizontal translation amount
     * @param vertical translation amount
     */
    ...
    /**
     * Generates a random number between the specified value1 and value2 numbers.
     * @param value1
     * @param value2
     ...
     * @param radians (fixed-point number)
     ...
     * @param Either LEFT, CENTER, or RIGHT
     */
