...
public interface SocketConnection extends StreamConnection
{
	 ...
	 * Set to a non-zero value to enable.</DL>
	 * 
	 */
	 ...
	 * disables the linger wait interval.</DL>
	 * 
	 */
	 ...
	 * Setting KEEPALIVE to a non-zero value will enable the feature.</DL>
	 * 
	 */
	public static final byte KEEPALIVE = 2;

	/**
	 * Socket option for the size of the <em>receiving buffer</em> (3).</DL>
	 * 
	 */
	public static final byte RCVBUF = 3;

	/**
	 * Socket option for the size of the <em>sending buffer</em> (4).</DL>
	 * 
	 * 
	 */
	 ...
	 * @throws IllegalArgumentException - if  the value is not valid (e.g. negative value) or if the option identifier is not valid
