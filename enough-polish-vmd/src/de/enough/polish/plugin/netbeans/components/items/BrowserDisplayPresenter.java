 ...
 * @author David Kaspar
 */
public class BrowserDisplayPresenter extends ItemDisplayPresenter {
    ...
    public BrowserDisplayPresenter () {
        panel = new JPanel ();
    ...
    public void reload (ScreenDeviceInfo deviceInfo) {
        ...
        PropertyValue propertyValue = getComponent ().readProperty (BrowserCD.PROP_URL);
    ...
    public Collection<ScreenPropertyDescriptor> getPropertyDescriptors () {
        ...
        list.add (new ScreenPropertyDescriptor (getComponent (), url, new ScreenStringPropertyEditor (BrowserCD.PROP_URL)));
        return list;
    }
