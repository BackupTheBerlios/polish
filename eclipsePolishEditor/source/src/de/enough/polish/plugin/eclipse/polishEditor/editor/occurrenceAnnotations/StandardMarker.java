...
public class StandardMarker extends AbstractOccurrenceAnnotationMarker{
//        
//        
//        
...
//
//      
//        public boolean ableToMark(IDocument document, ITextSelection selection) {
//            boolean caretInPolishDirectiveLine = caretInPolishDirectiveLine(selection);
//            String wordAtCaretPosition = findWordAtSelectionCaret(document,selection);
//            boolean wordAtCaretPositionHasnonZeroLength = wordAtCaretPosition == null?false:wordAtCaretPosition.length() > 0;
//            if(caretInPolishDirectiveLine && wordAtCaretPositionHasnonZeroLength) {
//                return true;
//            }
//            return false;
//        }
//
//        
//        public void updateAnnotations(IDocument document, List commentLines, ITextSelection selection, IAnnotationModel annotationModel) {
//            // TODO ricky implement updateAnnotations
//            
//        }
//        
...
//                return;
//            }
//            if( ! caretInPolishDirectiveLine(selection)) {
...
//       
//
//	private boolean caretInPolishDirectiveLine(ITextSelection selection) {
...
//        }
//
//        private String findWordAtSelectionCaret(IDocument document, ITextSelection selection) {
//            String word = "";
...
//        
//        
//        // Replace this method with a more general configuration method.
