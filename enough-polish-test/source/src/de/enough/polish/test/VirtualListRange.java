...
public class VirtualListRange {
	...
	public VirtualListRange(int referenceHeight, int availableHeight, int minimumItems) {
	...
	void setRange(int start, int end, int total) {
		...
		this.maximumY = ((start * this.referenceHeight) + this.listHeight) - getLimitHeight();
