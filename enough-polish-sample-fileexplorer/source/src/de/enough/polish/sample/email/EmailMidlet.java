...
import de.enough.polish.io.file.UiFileSystemTreeModel;
...
implements CommandListener, ItemStateListener
{
	...
	public EmailMidlet() {
		super();
		//#debug
		System.out.println("file explorer midlet created");
	}
	...
	protected void startApp() throws MIDletStateChangeException {
		...
		//#style mailForm
		Form form = new Form("File Explorer");
		//#style mailTree
		TreeItem tree = new TreeItem( null, new UiFileSystemTreeModel() );
		//TreeItem tree = new TreeItem( null, new EmailTreeModel() );
		form.append( tree );				
