/*
 * Created on Jun 11, 2008 at 2:10:06 PM.
 * 
...
public class MotorolaModelNameExtractor implements ModelNameExtractor{
    ...
    public List<String> matchModel(String modelNameToMatch) {
        ...
        String modelName = modelNameToMatch.replace("RAZR ","");
