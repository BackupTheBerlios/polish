...
public class Stats{
        ...
        private List<String> modelNamesWithSlash = new LinkedList<String>();
        private int modelNameContainsComma;
		private int emptyModelNameFound;
...
//            System.out.println("devicesMapped:"+identifier+":"+wurfleId);
        ...
        public void print() {
            ...
            System.out.print("Devices with slashes:");
            for (String modelNameWithSlash : this.modelNamesWithSlash) {
                System.out.print(modelNameWithSlash+"|");
            }
            System.out.println();
            System.out.println("# of wurfl devices with empty model name:"+this.emptyModelNameFound);
		...
		public void emptyModelNameFound(String key) {
			this.emptyModelNameFound++;
		}
    }