...
public class Node
{
    ...
    */
    ...
    public static class Jump extends Node
    {
        ...
        {
            if (!(nType == Token.BREAK || nType == Token.CONTINUE)) Kit.codeBug();
            return jumpNode;
        }
        ...
        {
            if (!(nType == Token.SWITCH)) Kit.codeBug();
            return target2;
        }
        ...
        {
            if (!(nType == Token.SWITCH)) Kit.codeBug();
            if (defaultTarget.nType != Token.TARGET) Kit.codeBug();
        ...
        {
            if (!(nType == Token.TRY)) Kit.codeBug();
            return target2;
        }
        ...
        {
            if (!(nType == Token.TRY)) Kit.codeBug();
            if (finallyTarget.nType != Token.TARGET) Kit.codeBug();
            if (target2 != null) Kit.codeBug(); //only once
        ...
        {
            if (!(nType == Token.LABEL)) Kit.codeBug();
            return jumpNode;
        }
        ...
        {
            if (nType != Token.LOOP) Kit.codeBug();
            return target2;
        }
        ...
        {
            if (nType != Token.LOOP) Kit.codeBug();
            if (continueTarget.nType != Token.TARGET) Kit.codeBug();
            if (target2 != null) Kit.codeBug(); //only once
    ...
    public void removeProp(int propType)
    {
        ...
        if (x != null) {
            ...
            if (prev == null) {
                propListHead = x.nextItem;
            } else {
                prev.nextItem = x.nextItem;
            }
        }
    }
    ...
    {
        if (nType != Token.TARGET) Kit.codeBug();
    ...
    int nType;              // type of the node; Token.NAME for example
    Node next;             // next sibling
    private Node first;    // first element of a linked list of children
    private Node last;     // last element of a linked list of children
    private int lineno_ren = -1;    // encapsulated int data; depends on type
