...
public class NativeScript extends BaseFunction
{
    ...
    {
        this.script_ren = null;
    }

    private NativeScript(Script script)
    {
        this.script_ren = script;
    }
    ...
    {
        if (script_ren != null) {
            return script_ren.exec(cx, scope);
        }
                             ...
                             Scriptable thisObj, Object[] args)
    {
        ...
        switch (id) {
          ...
          case Id_compile: {
            ...
            real.script_ren = compile(cx, source);
            return real;
          }
        }
...
// #/string_id_map#
    ...
    private Script script_ren;
    
	
	public void read(DataInputStream in) throws IOException {
		super.read(in);
		script_ren = (Script) Serializer.deserialize(in);
	}

	
	public void write(DataOutputStream out) throws IOException {
		super.write(out);
		Serializer.serialize(script_ren, out);
	}
