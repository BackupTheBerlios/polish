    ...
    implements IdFunctionCall
{
    ...
    public static final class PrototypeValues implements Externalizable
    {
		...
		public void read(DataInputStream in) throws IOException {
			attributeArray = (short[]) Serializer.deserialize(in);
			constructor = (IdFunctionObject) Serializer.deserialize(in);
			constructorAttrs = in.readShort();
			lastFoundId = in.readInt();
			maxId = in.readInt();
			obj = (IdScriptableObject) Serializer.deserialize(in);
			valueArray = (Object[]) Serializer.deserialize(in);
		}

		
		public void write(DataOutputStream out) throws IOException {
			Serializer.serialize(attributeArray, out);
			Serializer.serialize(constructor, out);
			out.writeShort(constructorAttrs);
			out.writeInt(lastFoundId);
			out.writeInt(maxId);
			Serializer.serialize(obj, out);
			Serializer.serialize(valueArray, out);
		}
    }
