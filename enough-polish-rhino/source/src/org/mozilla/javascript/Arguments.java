...
// it indicates deleted index, in which case super class is queried.
	...
	public void read(DataInputStream in) throws IOException {
		super.read(in);
		activation = (NativeCall) Serializer.deserialize(in);
		args = (Object[]) Serializer.deserialize(in);
		calleeObj = Serializer.deserialize(in);
		callerObj = Serializer.deserialize(in);
		lengthObj = Serializer.deserialize(in);
	}

	
	public void write(DataOutputStream out) throws IOException {
		super.write(out);
		Serializer.serialize(activation, out);
		Serializer.serialize(args, out);
		Serializer.serialize(calleeObj, out);
		Serializer.serialize(callerObj, out);
		Serializer.serialize(lengthObj, out);
	}
}
