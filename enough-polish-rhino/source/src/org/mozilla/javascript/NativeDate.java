 ...
 * @author Mike McCabe
 */
final public class NativeDate extends IdScriptableObject
{
    ...
    static void init(Scriptable scope, boolean sealed)
    {
        ...
        obj.internalDate = ScriptRuntime.NaN;
    ...
    public Date getDate()
    {
    	return new Date((long) internalDate);
    }
    ...
    protected void initPrototypeId(int id)
    {
        ...
        switch (id) {
          ...
          case Id_toShortString:      arity=0; s="toShortString";      break;
          case Id_toShortTimeString:  arity=0; s="toShortTimeString";  break;
          case Id_toShortDateString:  arity=0; s="toShortDateString";  break;
                             ...
                             Scriptable thisObj, Object[] args)
    {
        ...
        double t = realThis.internalDate;
        ...
        switch (id) {
          ...
          case Id_toShortString:
          case Id_toShortTimeString:
          case Id_toShortDateString:
            if (t == t) {
                return shortDate_format(t, id);
            }
            return js_NaN_date_str;
...
//                return toLocale_helper(t, id);
    ...
    private static String shortDate_format(double t, int methodId)
    {
        ...
        if (methodId != Id_toShortTimeString) {
            ...
            if (methodId != Id_toShortDateString)
                result.append(' ');
        }
    ...
    private static String date_format(double t, int methodId)
    {
        ...
        if (methodId != Id_toDateString) {
            ...
            date.setTime(new Date((long) t));
            result.append(TimeZone.getDefault().getID());
            result.append(')');
        }
        return result.toString();
    }
    ...
    private static Object jsConstructor(Object[] args)
    {
        ...
        if (args.length == 1) {
            ...
            obj.internalDate = TimeClip(date);
            return obj;
        }
...
// #generated# Last update: 2007-05-09 08:15:38 EDT
        L0: { id = 0; String X = null; int c;
            ...
            case 13: c=s.charAt(0);
                ...
                else if (c=='t') { X="toShortString";id=Id_toShortString; }
                break L;
            ...
            case 17: c=s.charAt(0);
            	if (c=='g') {X="getTimezoneOffset";id=Id_getTimezoneOffset; }
            	else if (c=='t') {
            		c=s.charAt(7);
            		if(c=='D') { X="toShortDateString"; id=Id_toShortDateString; }
            		else if (c=='T') { X="toShortTimeString"; id=Id_toShortTimeString; }
            	}
                break L;
...
// #/generated#
    ...
    private static final int
        ...
        Id_setYear              = 45,
        Id_toShortString		= 46,
        Id_toShortTimeString	= 47,
        Id_toShortDateString	= 48,
...
//    private static java.text.DateFormat localeTimeFormatter;
    ...
    private double internalDate;

	
	public void read(DataInputStream in) throws IOException {
		super.read(in);
		internalDate = in.readDouble();
	}

	
	public void write(DataOutputStream out) throws IOException {
		super.write(out);
		out.writeDouble(internalDate);
	}
}
