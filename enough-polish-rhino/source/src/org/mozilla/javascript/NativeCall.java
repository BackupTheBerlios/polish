...
public final class NativeCall extends IdScriptableObject
{
    ...
    NativeCall(NativeFunction function, Scriptable scope, Object[] args)
    {
        ...
        if (paramAndVarCount != 0) {
            for (int i = 0; i < paramCount && i < paramAndVarCount; ++i) {
	...
	public void read(DataInputStream in) throws IOException {
		super.read(in);
		function = (NativeFunction) Serializer.deserialize(in);;
		originalArgs = (Object[]) Serializer.deserialize(in);
	}

	
	public void write(DataOutputStream out) throws IOException {
		super.write(out);
		Serializer.serialize(function, out);
		Serializer.serialize(originalArgs, out);
	}
}
