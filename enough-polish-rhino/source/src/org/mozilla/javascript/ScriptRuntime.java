...
//        }
    ...
    {
        for (;;) {
        	if (val instanceof Integer)/* added by GRB*/
    ...
    // Moved here from inside of stringToNumber() for Dotter
    final static int SKIP_LEADING_ZEROS = 0;
    final static int FIRST_EXACT_53_BITS = 1;
    final static int AFTER_BIT_53         = 2;
    final static int ZEROS_AFTER_54 = 3;
    final static int MIXED_AFTER_54 = 4;
...
//                final int MIXED_AFTER_54 = 4;
    ...
    public static double toNumber(String s) {
        ...
        for (;;) {
            ...
            if (!SFCharacter.isWhitespace(startChar))
                break;
            start++;
        }
        ...
        int end = len - 1;
        char endChar;
        while (SFCharacter.isWhitespace(endChar = s.charAt(end)))
            end--;
        if (endChar == 'y') {
            // check for "Infinity"
    ...
    static boolean isValidIdentifierName(String s)
    {
        ...
        if (L == 0)
            return false;
        if (!SFCharacter.isJavaIdentifierStart(s.charAt(0)))
            return false;
        for (int i = 1; i != L; ++i) {
            if (!SFCharacter.isJavaIdentifierPart(s.charAt(i)))
                return false;
        }
    ...
    public static String toString(Object val) {
        for (;;) {
            ...
            if (val instanceof Double) {
                ...
                // about Numbers?
                return numberToString(((Double)val).doubleValue(), 10);
            }
            if (val instanceof Scriptable) {
    ...
    public static String numberToString(double d, int baseTo) {
        if (d != d)
            return "NaN";
        ...
        if ((baseTo < 2) || (baseTo > 36)) {
            throw Context.reportRuntimeError1(
                "msg.bad.radix", Integer.toString(baseTo));
        }

        if (baseTo != 10) {
            return DToA.JS_dtobasestr(baseTo, d);
        } else {
...
//            return (Scriptable) wrapped;
    ...
    static String toStringIdOrIndex(Context cx, Object id)
    {
        if (id instanceof Double) {
            double d = ((Double)id).doubleValue();
            int index = (int)d;
            if (index == d) {
    ...
    public static Object enumInit(Object value, Context cx, boolean enumValues)
    {
        ...
        x.obj_ren = toObjectOrNull(cx, value);
        if (x.obj_ren != null) {
    ...
    public static Boolean enumNext(Object enumObj)
    {
        ...
        for (;;) {
            ...
            if (x.iindex == x.oids.length) {
                x.obj_ren = x.obj_ren.getPrototype();
                enumChangeObject(x);
                continue;
            }
            Object id = x.oids[x.iindex++];
            if (x.used != null && x.used.has(id)) {
                continue;
            }
            if (id instanceof String) {
                String strId = (String)id;
                if (!x.obj_ren.has(strId, x.obj_ren))
                    continue;   // must have been deleted
                x.currentId = strId;
            } else {
                int intId = ((Double)id).intValue();
                if (!x.obj_ren.has(intId, x.obj_ren))
                    continue;   // must have been deleted
    ...
    public static Object enumId(Object enumObj, Context cx)
    {
        ...
        if (s == null) {
            int index = lastIndexResult(cx);
            result = x.obj_ren.get(index, x.obj_ren);
        } else {
            result = x.obj_ren.get(s, x.obj_ren);
        }
    ...
    {
        Object[] ids = null;
        while (x.obj_ren != null) {
            ids = x.obj_ren.getIds();
            if (ids.length != 0) {
                break;
            }
            x.obj_ren = x.obj_ren.getPrototype();
        }
        if (x.obj_ren != null && x.oids != null) {
            Object[] previous = x.oids;
     ...
     * The typeof operator
     */
    public static String typeofJS(Object value)
    {
        if (value == null)
            return "object";
        if (value == Undefined.instance)
    ...
    public static String typeofName(Scriptable scope, String id)
    {
        ...
        if (val == null)
            return "undefined";
        return typeofJS(getObjectProp(val, id, cx));
    }
    ...
    public static Object add(Object val1, Object val2, Context cx)
    {
        if(val1 instanceof Double && val2 instanceof Double) {
            return wrapNumber(((Double)val1).doubleValue() +
    ...
    public static boolean eq(Object x, Object y)
    {
        if (x == null || x == Undefined.instance) {
            ...
            return eqNumber(((Double)x).doubleValue(), y);
            ...
            if (y instanceof Scriptable) {
                ...
                return eqNumber(((Double)y).doubleValue(), x);
    ...
    private static boolean eqString(String x, Object y)
    {
        for (;;) {
            if (y == null || y == Undefined.instance) {
                ...
                return toNumber(x) == ((Double)y).doubleValue();
            } else if (y instanceof Boolean) {
     ...
     */
    public static boolean inJS(Object a, Object b, Context cx)
    {
        if (!(b instanceof Scriptable)) {
            throw typeError0("msg.instanceof.not.object");
        }
                                           ...
                                           Context cx, Scriptable scope)
    {
      ...
      getObj:
        if (t instanceof JavaScriptException) {
            ...
            String sourceUri = re.getSourceName();
            if (sourceUri == null) {
                sourceUri = "";
            }
            int line = re.getLineNumber();
            Object args[];
            if (line > 0) {
...
//#        return formatter.format(arguments);
        ...
        if (arguments != null) {
			for (int i = 0; i < arguments.length; i++) {
				message.append(" ").append(arguments[i].toString());
			}
        }
