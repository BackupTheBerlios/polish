...
// #/string_id_map#
                                        ...
                                        Object[] args)
    {
        ...
        // mode.
        return cx.compileFunction(global, source, new Interpreter(), reporter, sourceURI, 1);
    }
...
// #/string_id_map#
	...
	public void read(DataInputStream in) throws IOException {
		super.read(in);
		prototypeProperty = Serializer.deserialize(in);
		prototypePropertyAttributes = in.readInt();
	}

	
	public void write(DataOutputStream out) throws IOException {
		super.write(out);
		Serializer.serialize(prototypeProperty, out);
		out.writeInt(prototypePropertyAttributes);
	}
}
