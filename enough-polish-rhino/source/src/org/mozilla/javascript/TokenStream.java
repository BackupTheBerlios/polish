...
// #generated# Last update: 2001-06-01 17:45:01 CEST
        L0: { id = 0; String X = null; int c;
            ...
            case 4: switch (s.charAt(0)) {
                case 'b': X="byte";id=Id_byte_; break L;
                case 'c': c=s.charAt(3);
...
// #/string_id_map#
    ...
    retry:
        for (;;) {
            ...
            if (c == '\\') {
                ...
                identifierStart = SFCharacter.isJavaIdentifierStart((char)c);
                if (identifierStart) {
                    stringBufferTop = 0;
                    addToString(c);
                }
                ...
                for (;;) {
                    if (isUnicodeEscapeStart) {
                        ...
                        if (c == '\\') {
                            ...
                            if (c == EOF_CHAR
                                || !SFCharacter.isJavaIdentifierPart((char)c))
                            {
                                break;
                            }
                            addToString(c);
            ...
            if (isDigit(c) || (c == '.' && isDigit(peekChar()))) {
                ...
                if (baseTo == 10 && !isInteger) {
                    ...
                    dval = ScriptRuntime.stringToNumber(numString, 0, baseTo);
                }
    ...
    {
        return c > 127 && SFCharacter.getType((char)c) == SFCharacter.FORMAT;
    }
