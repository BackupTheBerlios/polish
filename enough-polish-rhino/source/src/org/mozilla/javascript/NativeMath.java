...
final public class NativeMath extends IdScriptableObject
{
    ...
    protected void initPrototypeId(int id)
    {
        if (id <= LAST_METHOD_ID) {
            ...
            double x;
            switch (id) {
              case Id_E:       x = Math.E;             name = "E";       
break;
              case Id_PI:      x = Math.PI;            name = "PI";      
break;
              case Id_LN10:    x = 2.302585092994046;  name = "LN10";    
break;
              case Id_LN2:     x = 0.6931471805599453; name = "LN2";     
break;
              case Id_LOG2E:   x = 1.4426950408889634; name = "LOG2E";   
break;
              case Id_LOG10E:  x = 0.4342944819032518; name = "LOG10E";  
break;
              case Id_SQRT1_2: x = 0.7071067811865476; name = "SQRT1_2"; 
break;
              case Id_SQRT2:   x = 1.4142135623730951; name = "SQRT2";   
break;
              default: throw new IllegalStateException(String.valueOf(id));
            }
    ...
    public Object execIdCall(IdFunctionObject f, Context cx, Scriptable 
scope,
                             Scriptable thisObj, Object[] args)
    {
        ...
        switch (methodId) {
            ...
            case Id_round:
                ...
                {
                    // Round only finite x
                    long l = (long)(int)((x+0.5)*100.0)/100;
                    if (l != 0) {
                        x = l;
                    } else {
            ...
            default: throw new 
IllegalStateException(String.valueOf(methodId));
        }
...
// #generated# Last update: 2004-03-17 13:51:32 CET
        L0: { id = 0; String X = null; int c;
            ...
            case 2: if (s.charAt(0)=='P' && s.charAt(1)=='I') {id=Id_PI; 
break L0;} break L;
            case 3: switch (s.charAt(0)) {
                case 'L': if (s.charAt(2)=='2' && s.charAt(1)=='N') 
{id=Id_LN2; break L0;} break L;
                case 'a': if (s.charAt(2)=='s' && s.charAt(1)=='b') 
{id=Id_abs; break L0;} break L;
                case 'm': c=s.charAt(2);
                    if (c=='n') { if (s.charAt(1)=='i') {id=Id_min; 
break L0;} }
                    else if (c=='x') { if (s.charAt(1)=='a') {id=Id_max; 
break L0;} }
                    break L;
                } break L;
...
//        Id_tan          = 19,
    ...
    // Konstanten d�rfen keine Operationen enthalten (Probleme mit Dotter v0.4)
    private static final int
        Id_E            = 9,
        Id_PI           = 10,
        Id_LN10         = 11,
