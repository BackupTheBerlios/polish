//#condition (polish.midp1 && ! polish.api.siemens-color-game-api) || (polish.usePolishGameApi == true) || polish.blackberry || (polish.doja && polish.usePolishGui) || polish.android
