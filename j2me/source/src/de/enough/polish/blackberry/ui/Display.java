...
implements TrackwheelListener, KeyListener
{
	/**
	...
	public static Hashtable displaysByMIDlet = new Hashtable();
	...
	private Display( MIDlet midlet ) {
		this.midlet = midlet;
//		this.midlet.addTrackwheelListener( this );
//		this.midlet.addKeyListener( this );
	}
	...
	{
		Display display = (Display) displaysByMIDlet.get( m );
		if ( display == null ) {
			display = new Display( m );
			displaysByMIDlet.put( m, display );
		}
		return display;
	}
	...
	public void setCurrent( Displayable nextDisplayable)
	{
        ...
        synchronized (lock) {
            if (this.current != null) {
                ...
                this.midlet.popScreen( this.current );
            }
            this.current = nextDisplayable;
            this.midlet.pushScreen( nextDisplayable );
	...
	public boolean trackwheelClick( int arg0, int arg1 ) {
		// TODO Auto-generated method stub
		return false;
	}

	public boolean trackwheelUnclick( int arg0, int arg1 ) {
		// TODO Auto-generated method stub
		return false;
	}

	public boolean trackwheelRoll( int amount, int status, int time ) {
		if (this.current == null || !this.current.isSelecting() ) {
			System.out.println("Display - trackwheelRoll: aborting");
			return false;
		}		
		return ((Canvas)this.current).trackwheelRoll( amount, status, time );
	}
	...
	public boolean keyDown(int keyCode, int time) {
		...
		//#if !polish.LibraryBuild
			...
			//# }
		//#endif
		((Canvas)this.current).keyPressed( keyCode );
		if (screen == null) {
			return true;
		} else {
	...
	public boolean keyRepeat(int keyCode, int time) {
		...
		((Canvas)this.current).keyRepeated( keyCode );
		return true;
	}
