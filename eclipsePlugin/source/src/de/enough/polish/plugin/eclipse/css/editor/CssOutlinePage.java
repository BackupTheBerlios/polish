...
public class CssOutlinePage extends ContentOutlinePage {
	...
	public void createControl(Composite parent) {
		...
		DummyContentProvider dummyContentProvider= new DummyContentProvider();
		
		TreeViewer viewer= getTreeViewer();
		viewer.setContentProvider(dummyContentProvider);
		viewer.setLabelProvider(new DummyLabelProvider());
		viewer.addSelectionChangedListener(this);
		
		viewer.setInput(dummyContentProvider.initialInput());
	}
