...
import de.enough.polish.styleeditor.editors.attributes.PrimitiveColorCssAttributeEditor;
 ...
 */
public class SwingPrimitiveColorCssAttributeEditor 
extends SwingCssAttributeEditor
{
	
	private final JButton colorButton;

	public SwingPrimitiveColorCssAttributeEditor() {
	...
	public void setPartEditor( StylePartEditor partEditor ) {
		...
		PrimitiveColorCssAttributeEditor editor = (PrimitiveColorCssAttributeEditor) partEditor;
	...
	protected void handleActionPerformed(StylePartEditor stylePartEditor, ActionEvent event) {
		PrimitiveColorCssAttributeEditor editor = (PrimitiveColorCssAttributeEditor) stylePartEditor;
