 ...
 */
public class SwingSpecificAttributesEditor 
extends SwingStylePartEditor
{

	public SwingSpecificAttributesEditor() {		
		add( new JScrollPane(this.attributesPanel), BorderLayout.NORTH );
	...
	protected void handleActionPerformed(StylePartEditor stylePartEditor, ActionEvent event) {
		SpecificAttributesEditor editor = (SpecificAttributesEditor) stylePartEditor;
	...
	protected void updateGui(StylePartEditor stylePartEditor) {
		...
		String name = editor.getItemOrScreenClassName();
		if (name == null) {
			name = editor.getName();
		}
		this.swingStyleEditor.setPartEditorName( name, this );
