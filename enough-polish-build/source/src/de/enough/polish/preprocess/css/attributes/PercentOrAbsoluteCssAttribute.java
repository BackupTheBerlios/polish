...
/**
 * <p>A simple numerical attribute - when percent is used, it will result in a negative Integer value, e.g. 20% == -20.</p>
 *
 ...
 */
public class PercentOrAbsoluteCssAttribute extends CssAttribute {
	
	/**
	 * Creates a new instance.
	 */
	public PercentOrAbsoluteCssAttribute() {
		super();
	}
