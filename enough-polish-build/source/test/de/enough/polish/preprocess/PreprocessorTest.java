...
public class PreprocessorTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		variables.put( "polish.SoundFormat", "mp3, MIDI, amf");
	...
	public void testMessage() {
		...
		String[] sourceLines = new String[] {
				"	//#message the fullscreen-class is ${ fullscreen.class }",
				"	System.out.println( \"test1 is defined\" );",
				"	String hello =  \"hello world\";"
		};
		StringList lines = new StringList( sourceLines );
	...
	public void testTodo() {
		...
		String[] sourceLines = new String[] {
				"	//#todo use the fullscreen-class is = ${ fullscreen.class }",
				"	System.out.println( \"test1 is defined\" );",
				"	String hello =  \"hello world\";"
		};
		StringList lines = new StringList( sourceLines );
	...
	public void testForeach() {
		...
		String[] sourceLines = new String[] {
				...
				"		//#message foreach soundformat >>${format}<<",
				"		//#= System.out.println( \"Use format [${ lowercase(format) }]\" );",
		...
		int result = this.preprocessor.preprocess( "com.company.package.MyClass", lines );
		assertEquals( Preprocessor.CHANGED, result );
		assertEquals( sourceLines.length + 3 * 3, lines.size() );
		System.out.println("#foreach-result:");
		sourceLines = lines.getArray();
